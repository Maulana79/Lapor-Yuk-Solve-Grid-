...
export default function Register() {
  ...
  // Fungsi dummy untuk pura-pura mendaftar dan kembali ke halaman Login
      ...
      <div className="max-w-5xl w-full flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-16">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="bg-white rounded-[2rem] p-8 sm:p-10 shadow-2xl">
            ...
            {/* Toggle Metode Daftar (Email vs NIK) */}
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#00B27A]/20 focus:border-[#00B27A] transition-all"
                  required
                />
              </div>
              ...
              {/* Tambahan Kolom Konfirmasi Password */}
              <div>
              ...
              <button 
                type="submit" 
                className="w-full bg-[#00B27A] hover:bg-[#009968] text-white font-bold py-3.5 rounded-xl transition-colors shadow-md mt-4 flex justify-center items-center gap-2"
              >
                Daftar
              </button>
            </form>
          ...
          <div className="text-center mt-6">
            <p className="text-white/90 text-sm font-medium">
              Sudah punya akun? <Link to="/login" className="font-extrabold text-white hover:underline drop-shadow-sm">Login</Link>
            </p>
          </div>
        </div>
